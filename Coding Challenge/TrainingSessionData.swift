...
class TrainingSessionData : ObservableObject{
    ...
    @Published var level_predicted = [0]
    ...
    init(passed_seconds: Int, level_history: [Int],level_predicted: [Int], watt_history: [Int], bpm: Int, rpm: Int, kmh : Int, km : Double, kcal : Int){
        self.passed_seconds = passed_seconds
        self.level_history = level_history
        self.level_predicted = level_predicted
